...
function addRow(table : HTMLTableElement, student : Student) {
    ...
    if (student.focusArea) {
        ...
        majors.appendChild(document.createTextNode("No focus area"))
    }
...
// loading table
function loadingTable(table : HTMLTableElement, students : Student[]) {
...
window.onload = function() {
    loadingTable(selectTable(), students)
}